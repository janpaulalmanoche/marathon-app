...
const routes = [
    ...
    //this is temporay routes, to test api in drago tales
  {
    ...
    children: [
      ...
      {path:'/result',component: () => import('src/kiosk/Result.vue') },
      // {path:'/category',component: () => import('src/kiosk/Category.vue') },
      {path:'/cat-event-distance-fee',component: () => import('src/kiosk/EventCatDisFee.vue') },
      {path:'/category-distance-ranking',component: () => import('src/kiosk/CategoryDistanceRanking.vue') }
